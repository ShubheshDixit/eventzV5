import 'dart:async';
import 'package:admin_event/animations/fade_animations.dart';
import 'package:admin_event/animations/scale_animation.dart';
import 'package:admin_event/backend/database.dart';
import 'package:admin_event/backend/firebase_util.dart';
        ...
        child: widget.isLoading
            ...
            : ScaleAnimation(
                child: Container(
                  height: 50,
                  width:
                      widget.isLoading ? 50 : MediaQuery.of(context).size.width,
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          suffixIcon: IconButton(
            ...
            icon: FaIcon(
                !isOn ? FontAwesomeIcons.eye : FontAwesomeIcons.eyeSlash),
          ),
        ),
        maxLines: 1,
